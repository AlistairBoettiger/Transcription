...
% This code runs an alternate version of the main model where regulation
% occurs at the k_56 transtion not the k_78 transition.  
...
p = kba/(kab+kba); % probability of find ing the system in the enhancer active state. 
